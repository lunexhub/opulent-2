...
import furnitureRepair from "@/assets/furniture-repair.jpg";
...
const imageMap: Record<string, string> = {
  "@/assets/hero-living-room.jpg": heroImage,
  "@/assets/custom-couch.jpg": customCouch,
  "@/assets/furniture-repair.jpg": furnitureRepair,
  "@/assets/car-interior.jpg": carInterior,
};
